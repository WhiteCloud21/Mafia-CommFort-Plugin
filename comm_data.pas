...
const
  ...
  GD_CHANNELS_GET               = 1040; //plugin -> commfort: Список общих каналов. Блок данных (исходящий): [нулевое значение]. Блок данных (входящий): число(количество) + (текст(название канала) + число(количество пользователей в канале) + текст(тема канала))*количество
